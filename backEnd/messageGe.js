const messageGeneral = `<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8" />
  <title>Candidature spontanée – Développeur Full Stack Junior</title>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p>
        ...
        <strong>Développeur Full Stack Junior</strong>, en freelance ou CDI/CDD,
        selon vos besoins.
      </p>

      <p>
        Je suis <strong>Mohamed EDDAHMANI</strong>, étudiant à <strong>YouCode / UM6P</strong>,
        développeur Full Stack passionné par le développement web et mobile,
        avec une expérience sur des projets réels et un rôle de <strong>Team Lead</strong>.
      </p>
      ...
      <p>
        ...
        qu'ils soient orientés Frontend, Backend ou Full Stack. 
